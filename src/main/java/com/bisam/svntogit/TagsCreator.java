...
class TagsCreator implements InputStreamReaderRunnable.InputStreamLineHandler {
    ...
    public void handleLine(String originalTagName) {
        ...
        try {
            ...
            String tagComment = Strings.append("Tag: ", tag, " sha1: ", sha1, " using '", committerName, "' <",
                    committerEmail, "> on", commitDate);
            ...
            Executors.processAll(gitCreationCommandBuilder.start(), new InputStreamResultProvider(),
