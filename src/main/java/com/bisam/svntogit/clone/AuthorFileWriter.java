...
public class AuthorFileWriter {
  ...
  public static AuthorFileWriter init(String authorFilePath, MailSupplier mailSupplier) {
    return new AuthorFileWriter(authorFilePath, mailSupplier);
  }

  public void write(AuthorExtractor.Authors authors) throws IOException {
